...
ajax(
	{
	    ...
	    method: 'get'*/
	    url: 'https://api.spark.io/v1/devices/"insert device id"/lightOn?access_token="insert access token"',
	    method: 'post',
...
var main = new UI.Card({
  title: 'Light control',
  subtitle: 'Activate Room Lights',
  body: 'Shake to toggle lighting.' ,
...
main.on('click', 'down', function(e) {
	...
	ajax(
	{
	 	/*url: 'http://192.168.2.3/?9',
	    method: 'get'*/
	    url: 'https://api.spark.io/v1/devices/53ff68066667574829532367/lightOn?access_token=b0ca5a17f3e792da964848a381417f7201ae45e6',
	    //data: {'args=off'},
	    method: 'post'
...
//-d access_token=b0ca5a17f3e792da964848a381417f7201ae45e6
  ...
  var lightoff = new UI.Card();
  lightoff.title('A Card');
  lightoff.subtitle('Is a Window');
  lightoff.body('The simplest window type in Pebble.js.');
  lightoff.show();
